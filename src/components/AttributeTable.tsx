...
export default function AttributeTable({
    ...
    return (
      <div className="w-12 border-l border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-col items-center pt-16 pb-4 shrink-0 transition-all duration-300">
        <button
          ...
          className="p-2 text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 rounded-md hover:bg-indigo-50 dark:hover:bg-indigo-950/50 border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 shadow-xs transition duration-150 mt-4 mb-8"
        >
  ...
  return (
    <div className="w-[450px] border-l border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-col h-full shrink-0 shadow-xs font-sans transition-colors duration-200">
      ...
      <div className="flex-1 overflow-auto min-h-0 bg-white dark:bg-slate-900 relative">
        {!currentLayer ? (
          ...
          <table className="w-full text-left text-xs border-collapse font-sans">
            <thead>
              <tr className="bg-slate-100/60 dark:bg-slate-800/80 sticky top-0 border-b border-slate-200 dark:border-slate-800 shadow-xs z-10 text-slate-600 dark:text-slate-300 font-bold leading-tight select-none">
                ...
                return (
                  <tr
                    ...
                    className={`group cursor-pointer text-slate-700 dark:text-slate-200 transition duration-150 ${
                      isSelected 
                        ? "bg-indigo-50 dark:bg-indigo-950/60 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 text-indigo-900 dark:text-indigo-200 border-l-2 border-l-indigo-600 border-b border-indigo-200 dark:border-indigo-800" 
      ...
      {currentLayer && filteredFeatures.length > 50 && (
        <div className="px-4 py-2 bg-slate-50 dark:bg-slate-800 border-t border-b border-slate-200 dark:border-slate-800 flex items-center justify-between text-xs font-semibold select-none text-slate-600 dark:text-slate-300 shrink-0">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="px-2 py-0.5 rounded border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 disabled:opacity-40 disabled:hover:bg-white dark:disabled:hover:bg-slate-900 transition cursor-pointer text-[10px]"
            >
              Prev
            </button>
